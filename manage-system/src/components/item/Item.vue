<template>
  <div>
    ...
    <el-main>
      ...
      <!-- 获取商品列表数据 -->
      <el-table :data="itemList" style="width: 100%" stripe v-loading="loading" element-loading-text="拼命加载中"
        element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)" height="70vh">
        <div slot="empty"></div>
        ...
        <el-table-column prop="picture" label="商品图片" width="300px">
        </el-table-column>
        <el-table-column prop="owner" label="店家" width="300px">
        </el-table-column>
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
        :current-page="queryItemInfo.pageNum" :page-sizes="[10, 20, 50]" :page-size="queryItemInfo.pageSize"
